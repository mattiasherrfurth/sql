...
WITH
   myZZIL As 
      ...
      SELECT
         ...
         ilor_end_dt,
         to_char(ilor_end_dt + 1,'ww') as week,
         ilor_evaluation_cd,
         ilor_empl_id,
         empl_first_nm,
         empl_last_nm,
...
--            And qnot_orop_no = orop_no
      ...
      WHERE
         ILOR_END_DT >= TO_DATE('2019-01-01', 'YYYY-MM-DD') And ILOR_END_DT <= sysdate  --This date is 1 of 2 locations that time range must be changed
...
WHERE
   ...
   --And part_no = 'NP302K330G03'                                                  --(for testing)
