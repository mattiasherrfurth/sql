/*-----------------------------------------------------------------------------
-- Title:       Yield Plus QNs for Excel Query
-- Author:      Jordan Moshe
-- Created:     Q2 2019
-- Purpose:     This query pulls in the Pyramid yield data and the QNs associated with each evaluation.

-------------------------------------------------------------------------------
-- Current version:     1
-- Modification History:
--
-- Version 1 - Q2 2019 - Jordan Moshe
--      Published
-- Version 2 - 09/30/2019 - Mattias Herrfurth
--      Including Defect Code Description (qnct_tier3_cd) in table
-----------------------------------------------------------------------------*/
drop table if exists backupyieldplusqns;
SELECT 
